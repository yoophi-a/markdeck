...
test('createMarkdeckDesktopService registers IPC handlers for key desktop application use cases', (t) => {
...
test('createMarkdeckDesktopService validates required application ports up front', (t) => {
  installContentRepositorySpies(t);
  delete require.cache[require.resolve('./create-markdeck-desktop-service')];
  const { createMarkdeckDesktopService } = require('./create-markdeck-desktop-service');
